...
khail<-ggplot(allg, aes(x=collection_date, y=factor(r_result, level=result_order), group=site), na.rm=TRUE) +
...
ggsave("k_script_envs_hai_line.png", dpi = 500, height = 12, width = 20 , units = "in")
