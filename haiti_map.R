...
#TERRAIN MAP FOR HAITI
base = get_map(location=c(-74.5,18,-71,20), zoom=10, maptype="terrain-background")

map1=ggmap(base)

map1
map1 + geom_point(data=envs, aes(x=long, y=lat, fill=site), color="red", cex=2.5, show.legend = FALSE)+
